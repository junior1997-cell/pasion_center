<!DOCTYPE html>
<html lang="en" dir="ltr" data-nav-layout="horizontal" data-nav-style="menu-click" data-menu-position="fixed" data-theme-mode="light" style="--primary-rgb: 58, 88, 146;">
            ...
            <ul class="main-menu">
              ...
              <li class="slide has-sub">
                ...
                <ul class="slide-menu child1">
                  <li class="slide">
                    <a href="#statistics" class="side-menu__item">Estadísticas</a>
                  </li>
                  <li class="slide">
                    <a href="#our-mission" class="side-menu__item">Nuestra Misión</a>
                  </li>
                  <li class="slide">
                    <a href="#features" class="side-menu__item">Características</a>
                  </li>
                  <li class="slide">
