<!DOCTYPE html>
<html lang="es" dir="ltr" data-nav-layout="horizontal" data-nav-style="menu-click" data-menu-position="fixed" data-theme-mode="light" style="--primary-rgb: 78, 172, 76;">
...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="assets/images/brand-logos/ico-pasion-center.svg" >
    ...
    <div class="main-content landing-main px-0">
            ...
            <div class="row">
              <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                <div class="py-lg-5">
                  ...
                  <p class="landing-banner-heading mb-3">Equipado siempre. <span class="text-secondary">Pasión Center!</span></p>
                  <div class="fs-16 mb-5 text-fixed-white op-7">Pasión Center - Tecnología en tus manos: los mejores smartphones, siempre a tu alcance. ¡Descubre un nuevo nivel con nosotros!</div>
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-4">
                <div class="text-end landing-main-image landing-heading-img">
                  <img src="../assets/images/media/landing/4.png" alt="" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="text-center landing-main-footer py-3">
        <span class="text-muted fs-15"> Copyright © <span id="year"></span>
          <a href="javascript:void(0);" class="text-primary fw-semibold"><u>Pasion Center SAC</u></a>.
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" >
          ...
          <div class="modal-body" >
            <img src="assets/modulo/home/noticia/p-1.png" alt="Imagen Promocional" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
