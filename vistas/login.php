...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="gradient-x-overlay-lg-dark-videoo">
      ...
      <div class="d-lg-none position-absolute top-0 right-0 bottom-0 left-0 bg-img-hero" style="background-image: url(../assets/images/media/media-fondo-login.jpg);"></div>
    </div>
    <!-- End Hero Section -->    
  ...
  <script src="../assets/js/funcion_general.js?version_jdl=1.31"></script>
  <script src="../assets/js/funcion_crud.js?version_jdl=1.31"></script>  

  <script src="scripts/login.js?version_jdl=1.31"></script>  
