  ...
  <script>
     Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/pasion_center/vistas/`:window.location.origin}/vistas/`;
      } else {
