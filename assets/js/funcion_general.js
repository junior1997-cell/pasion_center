...
function doc_view_extencion(filename, url_carpeta='',  width='50%', height='auto', error_img = false,  url_complete = false) {
  ...
  if (url_complete == true) {
    ...
    ruta =  `${window.location.origin}/pasion_center/${url_carpeta}/${filename}`;     
    host = window.location.host == 'localhost' || es_numero(parseFloat(window.location.host)) == true ? `${window.location.origin}/pasion_center/${url_carpeta}/${filename}` : `${window.location.origin}/${url_carpeta}/${filename}` ;    
  }  
...
function doc_view_download_expand(filename, ruta='', nombre_decarga='', width='50%', height='auto', error_img = false) {
  ...
  var ruta_file = window.location.host == 'localhost' || es_numero(parseFloat(window.location.host)) == true ? `${window.location.origin}/pasion_center/${ruta}/${filename}` : `${window.location.origin}/${ruta}/${filename}` ;
...
function DocExist(url) {  
  ...
  var host = window.location.host == 'localhost' || es_numero(parseFloat(window.location.host)) == true ? `${window.location.origin}/pasion_center/${url}` : `${window.location.origin}/${url}`;
