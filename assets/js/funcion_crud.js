  ...
  if (e.status == 403) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/pasion_center/`:window.location.origin}`;
      } else {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {        
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/pasion_center/vistas/escritorio.php`:window.location.origin+'/vistas/escritorio.php'}`;
      } else {
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/pasion_center/vistas/escritorio.php`:window.location.origin+'/vistas/escritorio.php'}`;
      }
    });
